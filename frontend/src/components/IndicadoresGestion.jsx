...
const IndicadoresGestion = () => {
  ...
  const fetchObjetivosEstrategicos = async () => {
    try {
      ...
      console.error("Error al cargar los Indicadores Control de Gestión(MCI):", error);
      alert("Hubo un error al cargar los Indicadores Control de Gestión(MCI).");
    }
  };
  ...
  return (
    <div className="d-flex">
      ...
      <div className="container mt-5 flex-grow-1">
        <h2 className="text-primary mb-4">Indicadores Control de Gestión(MCI)</h2>
